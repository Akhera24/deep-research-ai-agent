...
Integration with Gemini 2.0 Flash for document processing.
...
class GeminiClient(BaseModelClient):
    """
    Gemini 2.0 Flash client implementation.
    ...
    - Cost: $5/$15 per 1M tokens (vs Claude's $15/$75)
    ...
    def __init__(self, config: Optional[ModelConfig] = None):
        ...
        if config is None:
            config = ModelConfig(
                ...
                max_tokens=8000,  # Gemini output limit
                temperature=0.3,
